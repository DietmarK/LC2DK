...
RS_ActionSelectWindow::RS_ActionSelectWindow(RS_EntityContainer& container,
        ...
        bool select, bool outside)     /* ++++++++++param 5 +++++++++++++ */
...
void RS_ActionSelectWindow::trigger() {
    ...
    if (v1.valid && v2.valid) {
	   ...
	   if(outside)
	     s.selectWindow(v1, v2, select, cross, true);   /* +++++++++ parameter 5 : outside ++++++++ */
	   else
	     s.selectWindow(v1, v2, select, cross, false);   /* +++++++++ parameter 5 : outside ++++++++ */
...
void RS_ActionSelectWindow::mouseMoveEvent(QMouseEvent* e) {
   ...
   //std::cout << " mouseMoveEvent " <<  getStatus() << "\n";
