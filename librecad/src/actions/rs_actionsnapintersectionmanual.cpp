...
RS_ActionSnapIntersectionManual::RS_ActionSnapIntersectionManual(
    ...
    coord = RS_Vector(false);
	   ...
	   connect (this, SIGNAL(ready()), appWindow->snapToolBar, SLOT(slotSIM0()));
	   connect (this, SIGNAL(begin()), appWindow->snapToolBar, SLOT(slotSIM1()));
...
void RS_ActionSnapIntersectionManual::updateToolBar() {
   ...
   // RS_DIALOGFACTORY->commandMessage("snapintersectionmanual");
