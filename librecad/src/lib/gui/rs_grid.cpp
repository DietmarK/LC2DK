...
//        std::cout<<"Grid userGrid="<<userGrid<<std::endl;
	   ...
	   int smallGrid = RS_SETTINGS->readEntry("/Grid-1-2-5", "0").toInt();
	   RS_SETTINGS->endGroup();
	   ...
	   if (smallGrid == 0)
		...
		//                RS_DEBUG->print("RS_Grid::update: 004");
	     ...
	     {		
		/* +++++++++ grid spacing in 3 steps: 1  2  5   10  20  50   ++++++++++++++++ */
		...
		// std::cout << "mgf= "<< metagridfaktor_x << "  x=" << gridWidth.x << "  mx=" << metaGridWidth.x << st$
