...
void RS_EventHandler::killSelectActions() {
    ...
    for (auto it=currentActions.begin();it != currentActions.end();){
        if ((*it)->rtti()==RS2::ActionSelectSingle ||
                ...
                /* ++++++++++++++++++++++++++ */
	    || (*it)->rtti()==RS2::ActionSelectCircles
	    || (*it)->rtti()==RS2::ActionSelectCirclesOnCircle
	    || (*it)->rtti()==RS2::ActionSelectCirclesInWindow
	    
	    || (*it)->rtti()==RS2::ActionDeselectOutsideWindow
	    || (*it)->rtti()==RS2::ActionSelectOutsideWindow
	    
	    || (*it)->rtti()==RS2::ActionDeselectInsideCircle
	    || (*it)->rtti()==RS2::ActionSelectInsideCircle
	    || (*it)->rtti()==RS2::ActionDeselectOutsideCircle
	    || (*it)->rtti()==RS2::ActionSelectOutsideCircle
	                    /* +++++++++++++++++++++++++++++++ */
