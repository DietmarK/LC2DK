...
bool RS_FilterDXF1::fileImport(RS_Graphic& g, const QString& file, RS2::FormatType /*type*/) {
   ...
   //std::cout << "RS_FilterDXF1::fileImport \n";
...
bool RS_FilterDXF1::readFromBuffer() {
    ...
    if(fBuf) {
        ...
        do {
	      ...
	      //std::cout << "RS_FilterDXF1:: if (dxfLine[0]=='$' ) " << qPrintable(dxfLine) << "\n";
	       ...
	       //std::cout << "RS_FilterDXF1:: if (dxfLine[0] A...Z ) " << qPrintable(dxfLine) << "\n";
...
//RLZ: unused                                    codeSeven=true;
		   ...
		   //std::cout << "RS_FilterDXF1:: DIMENSION \n";
		   ...
		   int typ=1;
			      ...
			      //std::cout << "else if(dxfLine==DIMENSION) " << code << "  " << qPrintable(dxfLine) << "\n";
...
void RS_FilterDXF1::strDecodeDxfString(QString& str) {
   ...
   //std::cout<<"RS_FilterDXF1::strDecodeDxfString a " <<qPrintable(str)<<std::endl;
   ...
   //std::cout<<"RS_FilterDXF1::strDecodeDxfString e " <<qPrintable(str)<<std::endl;
}
