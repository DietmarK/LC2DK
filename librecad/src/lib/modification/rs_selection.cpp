                                ...
                                bool select, bool cross, bool outside) 
{
   /* +++++++++ added parameter 5 ++++++++ */
    ...
    container->selectWindow(v1, v2, select, cross, outside);
...
/* +++++++++++++++++++++++++++ */
/**
 *  * Selects all entities that are completely inside / outside the given circle
 *  *
 *  * @param v1 center
 *  * @param v2 radius
 *  * @param select true: select, false: deselect
 *  * @param cross true: include entities partial in window
 *  * @param outside: regarding entities inside or outside
 *  */
void RS_Selection::selectCircle(const RS_Vector& cc, const double radius,
				                                bool select, bool cross, bool outside)
{
   container->selectCircle(cc, radius, select, cross, outside);
