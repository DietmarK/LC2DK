...
public:
   ...
   //virtual double getDistanceToPoint(const RS_Vector& coord, RS_Entity**, RS2::ResolveLevel, double)const{return coord.distanceTo(getInsertionPoint());}
   // dann geht snapentity nicht mehr
