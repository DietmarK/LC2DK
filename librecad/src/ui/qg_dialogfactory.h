...
protected:
   ...
   virtual void requestDimOrdinateOptions(RS_ActionInterface* action,
					  bool on, bool update);   /* +++++++++++++++++++++ */
...
public:
   ...
   virtual void requestOptionsGeneralDialogAdd();
   ...
   virtual void updateDimOrdinateOptions(const double&, const double&, bool, bool);   /* +++++++++++++++++++++++++++++ */
...
protected:
   ...
   QG_DimOrdinateOptions* dimOrdinateOptions;   /* +++++++++++++++++++++ */
