                                                                                                                ...
                                                                                                                QObject* obj2)
{
    ...
    case RS2::ActionSelectLayer:
     ...
     case RS2::ActionSelectCircles:
       action = RS_ActionSelectCircles::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotSelectCircles()));
       break;
       
     case RS2::ActionSelectCirclesOnCircle:
       action = RS_ActionSelectCircles::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotSelectCirclesOnCircle()));
       break;
       
     case RS2::ActionSelectCirclesInWindow:
       action = RS_ActionSelectCircles::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotSelectCirclesInWindow()));
       break;
     ...
     case RS2::ActionSelectOutsideWindow:
       action = RS_ActionSelectWindow::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotSelectOutsideWindow()));
       break;
              
     case RS2::ActionDeselectOutsideWindow:
       action = RS_ActionSelectWindow::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotDeselectOutsideWindow()));
       break;
              
       // ------------
       
     case RS2::ActionSelectInsideCircle:
       action = RS_ActionSelectCircle::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotSelectInsideCircle()));
       break;
              
     case RS2::ActionDeselectInsideCircle:
       action = RS_ActionSelectCircle::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotDeselectInsideCircle()));
       break;
              
     case RS2::ActionSelectOutsideCircle:
       action = RS_ActionSelectCircle::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotSelectOutsideCircle()));
       break;
              
     case RS2::ActionDeselectOutsideCircle:
       action = RS_ActionSelectCircle::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotDeselectOutsideCircle()));
       break;
    ...
    case RS2::ActionDrawArcTangential:
     ...
     case RS2::ActionDrawArcTangentialEndpoint:
       action = RS_ActionDrawArcTangential::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotDrawArcTangentialEndpoint()));
       break;
       /* ++++++++++++++++++++++++++++ */
    ...
    case RS2::ActionDimOrdinate:
                action = RS_ActionDimOrdinate::createGUIAction(id, mw);
        connect(action, SIGNAL(triggered()),
                obj, SLOT(slotDimOrdinate()));
        break;
      /* ++++++++++++++++++++++ */
    ...
    case RS2::ActionModifyExplodeText:
     ...
     case RS2::ActionModifyMoveZero:
       action = RS_ActionModifyMove::createGUIAction(id, mw);
       connect(action, SIGNAL(activated()), obj, SLOT(slotModifyMoveZero()));
       break;
       /* +++++++++++++++++++++++++++ */
...
//        break;
    ...
    case RS2::ActionSnapIntersectionManual:
        //not used any more  ??  aber ja doch !!!
...
/* RVT_PORT        action = new QAction(tr("Application"), QIcon(":/actions/configure.png"),
     ...
     case RS2::ActionOptionsGeneralAdd:
       action = new QAction(QIcon(":/actions/configure.png"),
			    tr("additional Preferences"),
			    mw);
       connect(action, SIGNAL(activated()),
	       obj, SLOT(slotOptionsGeneralAdd()));
       break;
