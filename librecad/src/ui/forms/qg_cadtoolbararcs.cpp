...
/* ++++++++++++++++++++++++++ */
void QG_CadToolBarArcs::drawArcTangentialEndpoint()
{
   if (cadToolBar!=NULL && actionHandler!=NULL) {
      actionHandler->slotDrawArcTangentialEndpoint();
   }
}
/* ++++++++++++++++++++++++ */
...
void QG_CadToolBarArcs::showCadToolBar(RS2::ActionType actionType) {
    ...
    case RS2::ActionDrawArcTangential:
       ...
       // std::cout << " QG_CadToolBarArcs::showCadToolBar case RS2::ActionDrawArcTangential: \n";
