...
void QG_DlgOptionsGeneralAdd::init() 
{
  ...
  lineEdit->setText(RS_SETTINGS->readEntry("/SnapCursorDiameter", "8.88"));
  
  lineEdit_2->setText(RS_SETTINGS->readEntry("/SnapCursorColor", "#ffaa00"));
  
  QString showSR =  RS_SETTINGS->readEntry("/ShowSnapRange", "1");
  checkBox_17->setChecked(showSR=="1");
  
  lineEdit_9->setText(RS_SETTINGS->readEntry("/SnapRangeColor", "#cccccc"));
  
  
  lineEdit_5->setText(RS_SETTINGS->readEntry("/AutoSnapRange", "8.88"));
  
  lineEdit_3->setText(RS_SETTINGS->readEntry("/AutoSnapCursorSize", "6"));
  
  lineEdit_4->setText(RS_SETTINGS->readEntry("/AutoSnapCursorColor", "#66ff33"));
  
  QString showASR =  RS_SETTINGS->readEntry("/ShowAutoSnapRange", "1");
  checkBox_19->setChecked(showASR=="1");
  
  lineEdit_10->setText(RS_SETTINGS->readEntry("/AutoSnapRangeColor", "#cccccc"));
  ...
  lineEdit_11->setText(RS_SETTINGS->readEntry("/FontSizeListEntities", "12"));
  
  lineEdit_13->setText(RS_SETTINGS->readEntry("/LineStyleFactorGraphic", "1.0"));
  lineEdit_12->setText(RS_SETTINGS->readEntry("/LineStyleFactorPrinter", "1.0"));
...
void QG_DlgOptionsGeneralAdd::ok() 
{
  ...
  RS_SETTINGS->writeEntry("/ShowSnapRange", QString("%1").arg((int)checkBox_17->isChecked()));
  RS_SETTINGS->writeEntry("/SnapRangeColor", lineEdit_9->text());
  RS_SETTINGS->writeEntry("/AutoSnapRange", lineEdit_5->text());
  RS_SETTINGS->writeEntry("/AutoSnapCursorSize", lineEdit_3->text());
  RS_SETTINGS->writeEntry("/AutoSnapCursorColor", lineEdit_4->text());
  RS_SETTINGS->writeEntry("/ShowAutoSnapRange", QString("%1").arg((int)checkBox_19->isChecked()));
  RS_SETTINGS->writeEntry("/AutoSnapRangeColor", lineEdit_10->text());
  ...
  RS_SETTINGS->writeEntry("/FontSizeListEntities", lineEdit_11->text());
  
  RS_SETTINGS->writeEntry("/LineStyleFactorGraphic", lineEdit_13->text());
  RS_SETTINGS->writeEntry("/LineStyleFactorPrinter", lineEdit_12->text());
