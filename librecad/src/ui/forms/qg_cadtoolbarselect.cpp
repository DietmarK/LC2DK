...
/* ++++++++++++++++++++ */
void QG_CadToolBarSelect::selectCircles() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotSelectCircles();
    }
}

void QG_CadToolBarSelect::selectCirclesOnCircle() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotSelectCirclesOnCircle();
    }
}

void QG_CadToolBarSelect::selectCirclesInWindow() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotSelectCirclesInWindow();
    }
}

void QG_CadToolBarSelect::selectOutsideWindow() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotSelectOutsideWindow();
    }
}

void QG_CadToolBarSelect::deselectOutsideWindow() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotDeselectOutsideWindow();
    }
}

void QG_CadToolBarSelect::selectInsideCircle() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotSelectInsideCircle();
    }
}

void QG_CadToolBarSelect::deselectInsideCircle() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotDeselectInsideCircle();
    }
}

void QG_CadToolBarSelect::selectOutsideCircle() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotSelectOutsideCircle();
    }
}

void QG_CadToolBarSelect::deselectOutsideCircle() 
{
    if (actionHandler!=NULL) {
        actionHandler->slotDeselectOutsideCircle();
    }
}
