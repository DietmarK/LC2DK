...
//#include "rs_actionsetsnapmode.h"      deleted
...
//        gv->killSelectActions();
    ...
    case RS2::ActionSelectWindow:
        gv->killSelectActions();
        a = new RS_ActionSelectWindow(*doc, *gv, true, false);   /* +++++++++++++ added 4. parameter */
        break;
    case RS2::ActionDeselectWindow:
        gv->killSelectActions();
        a = new RS_ActionSelectWindow(*doc, *gv, false, false);   /* +++++++++++++ added 4. parameter */
        break;
    ...
    case RS2::ActionSelectLayer:
       ...
       /* ++++++++++++++++++++ */
    case RS2::ActionSelectCircles:
        gv->killSelectActions();
        a = new RS_ActionSelectCircles(*doc, *gv, 1);
        break;

    case RS2::ActionSelectCirclesOnCircle:
        gv->killSelectActions();
        a = new RS_ActionSelectCircles(*doc, *gv, 2);
        break;

    case RS2::ActionSelectCirclesInWindow:
        gv->killSelectActions();
        a = new RS_ActionSelectCircles(*doc, *gv, 3);
        break;

       
       // ---------
    case RS2::ActionSelectOutsideWindow:
        gv->killSelectActions();
        a = new RS_ActionSelectWindow(*doc, *gv, true, true); 
        break;
    case RS2::ActionDeselectOutsideWindow:
        gv->killSelectActions();
        a = new RS_ActionSelectWindow(*doc, *gv, false, true); 
        break;

       // -----------
    case RS2::ActionSelectInsideCircle:
        gv->killSelectActions();
        a = new RS_ActionSelectCircle(*doc, *gv, true, false); 
        break;
    case RS2::ActionDeselectInsideCircle:
        gv->killSelectActions();
        a = new RS_ActionSelectCircle(*doc, *gv, false, false);
        break;
    case RS2::ActionSelectOutsideCircle:
        gv->killSelectActions();
        a = new RS_ActionSelectCircle(*doc, *gv, true, true); 
        break;
    case RS2::ActionDeselectOutsideCircle:
        gv->killSelectActions();
        a = new RS_ActionSelectCircle(*doc, *gv, false, true); 
        break;
       /* +++++++++++++++++++++++ */
    ...
    case RS2::ActionDrawArcTangential:
        a = new RS_ActionDrawArcTangential(*doc, *gv, false);   /* +++++++++++ 3. parameter added */
        break;

       /* +++++++++++++++++++++++++ */
     case RS2::ActionDrawArcTangentialEndpoint:
        a = new RS_ActionDrawArcTangential(*doc, *gv, true);
        break;
       /* +++++++++++++++++++++++++ */
    ...
    case RS2::ActionDimOrdinate:
        a = new RS_ActionDimOrdinate(*doc, *gv);   /* ++++++++++++++++++++++++++++ */
        break;
    ...
    case RS2::ActionModifyMoveNoSelect:
        a = new RS_ActionModifyMove(*doc, *gv, false);   /* +++++++++  */
        break;
       
       /* ++++++++++++++++++++++++++ */
    case RS2::ActionModifyMoveZero:
        a = new RS_ActionModifyMove(*doc, *gv, true);   /* +++++++++  */
        break;
       /* +++++++++++++++++++++++ */
...
//        a = new RS_ActionSetSnapMode(*doc, *gv, RS2::SnapAuto);
       slotSnapAuto();
       break;
       /* +++++++++++ */
...
//        a = new RS_ActionSetSnapRestriction(*doc, *gv, RS2::RestrictVertical);
    ...
    case RS2::ActionOptionsDrawing:
        ...
        break;
     case RS2::ActionDefault:	       /* +++++++++++++++++++ avoid warnings */
      break;			       /* +++++++++++++++++++ */
    default:
      /* ++++++++++++++++++++++ */
      std::cout << " qg_actionhandler.cpp : setCurrentAction():  action not handled:  id = " << id << "\n";
...
/* +++++++++++++++++++++++ */
void QG_ActionHandler::slotSelectCircles() 
{
    setCurrentAction(RS2::ActionSelectCircles);
}

void QG_ActionHandler::slotSelectCirclesOnCircle() 
{
    setCurrentAction(RS2::ActionSelectCirclesOnCircle);
}

void QG_ActionHandler::slotSelectCirclesInWindow() 
{
    setCurrentAction(RS2::ActionSelectCirclesInWindow);
}

void QG_ActionHandler::slotSelectOutsideWindow() 
{
    setCurrentAction(RS2::ActionSelectOutsideWindow);
}

void QG_ActionHandler::slotDeselectOutsideWindow() 
{
    setCurrentAction(RS2::ActionDeselectOutsideWindow);
}

void QG_ActionHandler::slotSelectInsideCircle() 
{
    setCurrentAction(RS2::ActionSelectInsideCircle);
}

void QG_ActionHandler::slotDeselectInsideCircle() 
{
    setCurrentAction(RS2::ActionDeselectInsideCircle);
}

void QG_ActionHandler::slotSelectOutsideCircle() 
{
    setCurrentAction(RS2::ActionSelectOutsideCircle);
}

void QG_ActionHandler::slotDeselectOutsideCircle() 
{
    setCurrentAction(RS2::ActionDeselectOutsideCircle);
}
/* ++++++++++++++++++++++++ */
...
/* ++++++++++++++++++++++++++ */
void QG_ActionHandler::slotDrawArcTangentialEndpoint() {
    setCurrentAction(RS2::ActionDrawArcTangentialEndpoint);
}
/* ++++++++++++++++++++++++++++++ */
...
void QG_ActionHandler::slotDimOrdinate() {
    setCurrentAction(RS2::ActionDimOrdinate);   /* +++++++++++++++++++ */
}
...
/* +++++++++++++++++++++++++++++ */
void QG_ActionHandler::slotModifyMoveZero() {
    setCurrentAction(RS2::ActionModifyMoveZero);
}
/*  ++++++++++++++++++++++++++ */
...
//    slotSetSnaps(s);
   ...
   snapToolBar->aTsnapFree();
}

/* ++++++++++++++++++++ */
void QG_ActionHandler::slotSnapAuto() {
//    disableSnaps();
//    if (snapAuto!=NULL) {
//        snapAuto->setChecked(true);
//    }
//    if (cadToolBarSnap!=NULL) {
//        cadToolBarSnap->setSnapMode(RS2::SnapAuto);
//    }
//    setCurrentAction(RS2::ActionSnapAuto);
    
//   RS_SnapMode s=getSnaps();
//   s.snapAuto = true;
//   slotSetSnaps(s);
   
   snapToolBar->aTsnapAuto();
}
/* ++++++++++++++ */
...
//    slotSetSnaps(s);
   ...
   snapToolBar->aTsnapIntersection();
}
...
void QG_ActionHandler::slotSnapIntersectionManual() {
   ...
   // std::cerr << "qg_actionhandler.cpp  void QG_ActionHandler::slotSnapIntersectionManual() " << std::endl;
   
   
    setCurrentAction(RS2::ActionSnapIntersectionManual);
}

void QG_ActionHandler::call_slotSIM0()
{
   snapToolBar->slotSIM0();
}

    
void QG_ActionHandler::call_slotSIM1()
{
   snapToolBar->slotSIM1();
}
...
void QG_ActionHandler::slotRestrictHorizontal() {
  ...
  //std::cout << "qg_actionhandler.cpp slotRestrictHorizontal   s.restriction a " << s.restriction << "\n";
  
  // toggle:
  if (s.restriction == RS2::RestrictHorizontal)
    s.restriction = RS2::SnapRestriction( s.restriction  & ~RS2::RestrictHorizontal);
  else
    s.restriction = RS2::SnapRestriction( s.restriction | RS2::RestrictHorizontal);
  
  //std::cout << "qg_actionhandler.cpp slotRestrictHorizontal   s.restriction e " << s.restriction << "\n";
...
void QG_ActionHandler::slotRestrictVertical() {
  ...
  // toggle:
  if (s.restriction == RS2::RestrictVertical)
    s.restriction = RS2::SnapRestriction( s.restriction  & ~RS2::RestrictVertical);
  else
    s.restriction = RS2::SnapRestriction( s.restriction | RS2::RestrictVertical);
