...
RS_Layer* QG_DialogFactory::requestNewLayerDialog(RS_LayerList* layerList) {
    ...
    if (layerList!=NULL) {
        ...
        while((long int)layerList->find(newLayerName) > 0) {
...
void QG_DialogFactory::requestOptions(RS_ActionInterface* action,
   ...
   //   std::cout << " QG_DialogFactory::requestOptions rtti= " << action->rtti() << "\n";
    ...
    case RS2::ActionDimAligned:
     ...
     case RS2::ActionDimLinear:	       /* 121 */
     case RS2::ActionDimLinearVer:     /* +++++++++++ */
     case RS2::ActionDimLinearHor:     /* +++++++++++ */
      
      // std::cout << "qg_dialogfactory.cpp : case RS2::ActionDimLinear:  \n";
    ...
    case RS2::ActionDimOrdinate:                        /* ++++++++++++++++++++++++ */
        requestDimOrdinateOptions(action, on, update);
        break;
...
/* +++++++++++++++++++++++++ */
void QG_DialogFactory::updateDimOrdinateOptions(const double& x, const double& y, bool set_Origin, bool X_type)
{
  if (dimOrdinateOptions==NULL) return;
  
  dimOrdinateOptions->updateOptions(x, y, set_Origin, X_type);
}
/* ++++++++++++++++++++++++++++ */
        ...
        bool on, bool update)
{
   ...
   // std::cout << "in QG_DialogFactory::requestDimensionOptions" <<  "\n";
...
/* +++++++++++++++++++++++++++++++ */
/**
 * Shows a widget for ordinate dimension options.
 */
void QG_DialogFactory::requestDimOrdinateOptions(RS_ActionInterface* action,
        bool on, bool update)
{
    //static QLabel* l = NULL;
    static QG_DimOrdinateOptions* toolWidget = NULL;
        ...
        if (toolWidget!=NULL) 
	{
        ...
        if (on==true) 
	{
            toolWidget = new QG_DimOrdinateOptions();
            optionWidget->addWidget(toolWidget);
            toolWidget->setAction(action, update);
	  toolWidget->show();
        }
      dimOrdinateOptions=toolWidget;
    }
...
if(cadToolBar != NULL){
   ...
   // std::cout << "QG_DialogFactory::showCadToolBar RS2::ActionType = " << actionType << "\n";
...
/*
 *  * Shows dialog for additional options.
 */

void QG_DialogFactory::requestOptionsGeneralDialogAdd() 
{
   
       QG_DlgOptionsGeneralAdd dlg(parent);
       dlg.exec();
}
