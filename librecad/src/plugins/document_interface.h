...
public:
   ...
   virtual RS_Pen getCurrentLayerPen() = 0;
   
   virtual void setCurrentLayerPen(RS_Pen) = 0;
   
   virtual  void activateLayer(const QString& name) = 0;
   
   virtual bool getAllEntities(QList<Plug_Entity *> *en) = 0;
