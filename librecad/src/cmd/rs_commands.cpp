...
RS_Commands::RS_Commands() {
   ...
   /* ++++++++++++++++++++++++++ */
    cmdTranslation.insert("mz", tr("mz"));   /* +++++++++++++ ?????? */
   mainCommands.insert(tr("mz", "modify - move zero"), RS2::ActionModifyMoveZero);
   shortCommands.insert(tr("mz"), RS2::ActionModifyMoveZero);
      /* +++++++++++++++++++++++++++ */
   ...
   /* +++++++++++++++++++++++ */
    cmdTranslation.insert("sy", tr("sy"));
   mainCommands.insert(tr("sy", "snap - auto"), RS2::ActionSnapAuto);
   shortCommands.insert(tr("sy"), RS2::ActionSnapAuto);
      
    cmdTranslation.insert("sx", tr("sx"));
   mainCommands.insert(tr("sx", "snap intersection manually"), RS2::ActionSnapIntersectionManual);
   shortCommands.insert(tr("sx"), RS2::ActionSnapIntersectionManual);
      
    cmdTranslation.insert("hh", tr("hh"));
  mainCommands.insert(tr("hh", "snap restrict horizontal"), RS2::ActionRestrictHorizontal);
   shortCommands.insert(tr("hh"), RS2::ActionRestrictHorizontal);
      
   cmdTranslation.insert("vv", tr("vv"));
   mainCommands.insert(tr("vv", "snap restrict vertical"), RS2::ActionRestrictVertical);
   shortCommands.insert(tr("vv"), RS2::ActionRestrictVertical);
