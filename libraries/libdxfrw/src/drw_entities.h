...
public:
    ...
    DRW_Coord getExtrusion() const {return extPoint;}            /*!< extrusion, code 210, 220 & 230 ++++++++++++++++++ const missing ! */
    void setExtrusion(const DRW_Coord p) {extPoint =p;}
    string getName() const {return name;}                        /*!< Name of the block that contains the entities, code 2  ++++++++++++++++++ const missing ! */
